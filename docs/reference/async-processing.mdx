...
description: Async Processing increases the level of parallelism in Kafka Streams from the level of a Kafka Partition to the level of a record Key. This results in significant throughput gains when processors have long-blocking operations like remote calls.
---
