...
of disaggregated state. It's particularly relevant to applications with high amounts of state since it solves the
...
SlateDB has applied to be a part of the CNCF and is [awaiting entry](https://github.com/cncf/sandbox/issues/114) into
the CNCF sandbox. Responsive has been one of the primary contributors to SlateDB from day 0, and we look forward to
building SlateDB with contributors from across the industry!
