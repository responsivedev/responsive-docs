...
options. For how to set up a policy see [Configure Policies](/products/control-plane/configure-policies).
...
See [Configure Controller Policy](/products/control-plane/configure-policies)
