...
The core Kafka Streams runtime can be broken into three layers depicted in <span className='text-blue-600'>blue</span>
...
The core Kafka Streams runtime relies on various subsystems, presented in <span className="text-amber-600">orange</span>
in the diagram above. These subsystems implement state management , task assignment, etc. and are abstracted away
from the core runtime through
