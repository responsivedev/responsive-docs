...
If you've already read our [Autoscaling Policy Reference](/reference/policies) you may notice
...
1. **A Policy Spec**: this is a [kubernetes custom resource](/reference/policies#custom-resource-specification)
...
- To see all available policies and learn how to specify them, see our [Technical Reference](/reference/policies).